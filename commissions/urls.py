...
urlpatterns = [
    ...
    path('detail/<int:pk>/update', CommissionUpdateView.as_view(), name="update"),
    path('jobs/<int:pk>/edit/', JobUpdateView.as_view(), name="update_job"),
    path('commissions/<int:commission_pk>/jobs/<int:job_pk>/applications/<int:pk>/update/', JobApplicationUpdateView.as_view(), name="update_job_application"),
